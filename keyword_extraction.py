...
def extract_phrases_keywords(ip):
    text = ip
    ...
    for word in keywords:
        keywords_phrases.append(word[0])


    res = {'keywords_and_phrases':keywords_phrases}
    res = json.dumps(res)

    return res

# e = extract_phrases_keywords('I felt bad for Thanos. There, I said it. He really did love Gamora, despite his insanity and his evil agenda. He genuinely believed that what he was doing was right. Thanos had a motive. He was a sympathetic character. He became my favorite villain, instantly. Thanos killed everyone, mercilessly and relentlessly. But I somehow felt sorry for him.')
#
# print(e)
